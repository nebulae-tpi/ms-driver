...
### 1. clone this repo  
   ```git clone https://github.com/nebulae-tpi/ms-driver.git```  
...
### 5. Compose FrontEnd
```
nebulae compose-ui development --shell-type=FUSE2_ANGULAR --shell-repo=https://github.com/nebulae-tpi/emi --frontend-id=emi --output-dir=/FULL_PATH_TO_REPO/ms-driver/playground/emi  --setup-file=/FULL_PATH_TO_REPO/ms-driver/etc/mfe-setup.json
```

### 6. Compose the API emi-gateway
```
nebulae compose-api development --api-type=NEBULAE_GATEWAY --api-repo=https://github.com/nebulae-tpi/emi-gateway --api-id=emi-gateway --output-dir=FULL_PATH_TO_REPO/ms-driver/playground/emi-gateway  --setup-file=FULL_PATH_TO_REPO/ms-driver/etc/mapi-setup.json
```
